...
class GeminiClient:
    ...
    def __init__(
        ...
        self.image_model = image_model or os.getenv("GEMINI_IMAGE_MODEL", "gemini-3-flash-preview")
        self.video_model = video_model or os.getenv("GEMINI_VIDEO_MODEL", "gemini-3-flash-preview")
